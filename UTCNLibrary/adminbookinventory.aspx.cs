    ...
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        void updateBookByID()
        {
            if (checkIfBookExist())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tbl set book_name=@book_name, genre=@genre, author_name=@author_name, publisher_name=@publisher_name, publish_date=@publish_date, language=@language, edition=@edition, book_cost=@book_cost, pages=@pages, book_description=@book_description, actual_stock=@actual_stock, current_stock=@current_stock, book_img_link=@book_img_link where book_id='" + TextBox1.Text.Trim() + "'", con);
        ...
        void addNewBook()
        {
            try
            {
                ...
                string filepath = "~/book_invetory/books1.png";
                string filename = Path.GetFileName(FileUpload1.PostedFile.FileName);
                FileUpload1.SaveAs(Server.MapPath("book_invetory/" + filename));
                filepath = "~/book_invetory/" + filename;
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl(book_id, book_name, genre, author_name, publisher_name, publish_date, language, edition, book_cost, pages, book_description, actual_stock, current_stock, book_img_link) values(@book_id, @book_name, @genre, @author_name, @publisher_name, @publish_date, @language, @edition, @book_cost, @pages, @book_description, @actual_stock, @current_stock, @book_img_link)", con);
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('Book has added succesfully.')</script>");
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
