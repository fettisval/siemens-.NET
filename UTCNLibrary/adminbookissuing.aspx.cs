...
namespace UTCNLibrary
{
    public partial class adminbookissuing : System.Web.UI.Page
    {
        ...
        bool checkIfBookExist()
        {
            ...
            {
                Response.Write("<script>alert('Book doens;t exist');</script>");
                return false;
            }
        ...
        bool checkIfMemberExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT nume FROM member_master_tbl WHERE user_id='" + TextBox2.Text.Trim() + "'", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
        ...
        void getNames()
        {
            try
            {
                ...
                cmd = new SqlCommand("SELECT nume FROM member_master_tbl WHERE user_id='" + TextBox2.Text.Trim() + "'", con);
